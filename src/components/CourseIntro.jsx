  ...
  return (
    <div className="bg-black text-white text-center pt-15 md:py-30 flex flex-col items-center">
      ...
      <div className="relative w-full   flex justify-center items-center mx-auto mb-8">
        ...
        <video
          ref={videoRef}
          className="  mobile-s:w-[280px]  mobile-s:h-[200px]  w-[345px] h-[250px] lg:w-[1100px]  lg:h-auto   4xl:w-[16600px] 4xl:h-[1000px] object-cover sm:h-auto  rounded-2xl md:rounded-[15px]  shadow-lg"
          style={{
