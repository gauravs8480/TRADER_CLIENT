...
const HeroSection = () => {
  return (
    ...
    <div className="h-screen ">
      ...
      <NavBar />
      <div className=" 4xl:top-[820px]  relative   mobile-m:top-[150px]   mobile-s:top-[100px]  top-[186px]  lg:top-[290px] 3xl:top-[400px] w-full h-screen/2 lg:pt-0 flex flex-col  ">
        {/* Content Container */}
        <div
          className=" 
