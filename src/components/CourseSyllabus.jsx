              ...
              >
                <div className="w-full text-left lg:flex lg:items-center ">
                  ...
                  <div className="  lg:-mt-2">
                    ...
                    <p className="text-[15px]  lg:text-[18px]  3xl:text-[20px]  4xl:text-[22px] font-semibold text-gray-800 leading-[1.1] mb-5">
                      {course.teaser || "No teaser available"}
                    </p>
                  </div>
                </div>
                <span className="absolute right-4 top-3 lg:static lg:mr-1 4xl:mr-6">
                  <svg
