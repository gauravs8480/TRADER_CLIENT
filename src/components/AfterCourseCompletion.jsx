...
const AfterCourseCompletion = () => {
  return (
    <div className="bg-black text-white pt-15">
      ...
      {/* Card Sections */}
      <div className="flex flex-col lg:flex-row lg:justify-between lg:px-15  ">
        {/* Card Section 1 */}
        <div className="flex  flex-col lg:gap-4 ">
          {AfterCourseCard2.map((card) => (
            <div
              key={card.id}
              className="   w-[375px] h-[341px] lg:w-[500px] lg:h-[500px] 3xl:w-[690px] 3xl:h-[650px] rounded-[20px] shadow-lg overflow-hidden relative bg-white hover:bg-yellow-400 transition-colors duration-300 flex-shrink-0 mb-5"
            >
              {/* Image Section */}
        ...
        <div className="flex flex-col gap-4  lg:justify-end lg:mt-40 3xl:mt-65 mb-5  ">
          {AfterCourseCard.map((card) => (
            ...
            >
              ...
              {/* Text Section */}
              <div className="w-full h-[200px] px-2 bg-opacity-90 text-black lg:px-6 3xl:px-5 flex flex-col">
                <h2 className="text-[21px] pt-2 lg:text-[26px] 3xl:text-[30px] lg:pt-5 3xl:pt-6 font-semibold">
                  {card.title}
                </h2>
                <p className="text-[12px] pt-2 lg:text-[16px] 3xl:text-[20px] lg:pt-2">
